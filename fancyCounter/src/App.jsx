    ...
    <div className="bg-slate-600 w-screen h-screen flex justify-center items-center shadow-xl">
      <div className="bg-slate-500 w-80 h-96 grid grid-rows-10 rounded-md shadow-xl">
        ...
        <div className="flex justify-center row-span-2">
          <button
            className="bg-slate-300 w-full text-center rounded-bl-md flex justify-center items-center text-5xl pb-2"
            onClick={setDecrease}
          >
            -
          </button>
          <button
            className="bg-slate-300 w-full text-center rounded-br-md flex justify-center items-center text-5xl pb-2"
            onClick={setIncrease}
          >
            +
          </button>
